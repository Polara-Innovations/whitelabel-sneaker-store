import { Component, Input, Output, ViewChild, ElementRef, AfterViewInit, OnInit, OnDestroy, HostListener, OnChanges, SimpleChanges, EventEmitter } from '@angular/core';
...
export class ProductCarouselComponent implements OnInit, AfterViewInit, OnChanges, OnDestroy {
  ...
  @Output() productAction = new EventEmitter<Product>();
